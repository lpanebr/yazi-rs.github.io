...
- [first-non-directory.yazi](https://github.com/lpanebr/yazi-plugins/tree/main/first-non-directory.yazi) - Skip directories jumping to the first file with `fj`, or with your preffered keybind.
